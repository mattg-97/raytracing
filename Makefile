...
INCLUDES = -I$(SRCDIR) $(shell find $(SRCDIR) -type d -exec echo -I{} \;) -I/Library/Frameworks/SDL2.framework/Headers
...
$(TARGET): $(OBJS)
	@mkdir -p $(BINDIR)
	$(CC) $(CFLAGS) $^ -F/Library/Frameworks -framework SDL2 -Wl,-rpath,/Library/Frameworks -o $@
